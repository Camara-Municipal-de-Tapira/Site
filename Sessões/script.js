                        ...
                        try {
                            ...
                            html += `
                                <div class="card-materia ${classeCssAdicional}">
                                    ...
                                    <p><strong>Autor:</strong> ${nomeAutorReal}</p>
                                    <p><strong>Assunto:</strong> ${materia.ementa || 'Sem ementa cadastrada.'}</p>
                                    <p><a href="${materia.texto_original}" target="_blank" class="btn_baixar">Baixar matéria</a></p>
